defmodule Journal3.EntriesTest do
  use Journal3.DataCase

  alias Journal3.Entries

  describe "entries" do
    alias Journal3.Entries.Entry
    ...
    test "create_entry/1 with valid data creates a entry" do
      ...
      assert {:ok, {} = entry} = Entries.create_entry(valid_attrs)
    ...
    test "delete_entry/1 deletes the entry" do
      entry = entry_fixture()
      assert {:ok, {}} = Entries.delete_entry(entry)
